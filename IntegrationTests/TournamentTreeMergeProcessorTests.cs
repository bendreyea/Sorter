...
public class TournamentTreeMergeProcessorTests : IAsyncLifetime
{
    ...
    public TournamentTreeMergeProcessorTests()
    {
        ...
        var settings = new ExternalSorterSettings()
        {
            ...
            MergeBatch = 3 // Small batch to test recursion
        };
        
        _mergeProcessor = new TournamentMergeStrategyFiles(_fileSystem, settings);
    }
    ...
    public async ValueTask InitializeAsync()
    {
        for (var i = 0; i < 100; i++)
        {
            ...
            await _fileGenerator.GenerateFile(unsortedFile, 1024*10, TestContext.Current.CancellationToken);
